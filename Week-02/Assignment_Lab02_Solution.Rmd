...
# What is the mean temperature in July?
temp_july <- dat[dat$Month == 7, "Temp"]
mean(temp_july)

# What is the minimum and maximum concentration of ozone on in August?
ozone_august <- dat[dat$Month == 8, "Ozone"]
min(ozone_august, na.rm = TRUE)
max(ozone_august, na.rm = TRUE)
```
...
What is the mean increment (tree-ring width) for plot X40B?
