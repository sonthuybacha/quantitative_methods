...
The factors are always recoded into m-1 binary dummy variables, as the *base-level* is represented by the intercept and slope of of the regression line R picks the base-level alphabetically! 
...
As we see, there are several models with $\Delta AIC < 4$. Hence, those models are equally likely give the data. Which one should we take as our 'true' mdoel?
...
Any analyse it as shown in the previous slides.
