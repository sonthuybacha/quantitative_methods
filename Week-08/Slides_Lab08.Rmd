...
The link-function is $g(\theta) = ln(\theta)$ and the inverse is $g^{-1}(\theta) = ln^{-1}(\theta) = e^{\theta}$. The data distribution is still assumed to be normal and the model can also be written as: 
